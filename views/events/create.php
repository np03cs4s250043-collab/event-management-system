    ...
    <form method="POST" action="" enctype="multipart/form-data" style="<?= isset($event) ? 'max-width:720px' : 'display:grid;grid-template-columns:2fr 1fr;gap:2rem;align-items:start' ?>">
        ...
        <div style="background:white;border-radius:0.75rem;padding:2rem;box-shadow:0 2px 8px rgba(0,0,0,0.04)">
            ...
            <div class="form-group">
                ...
                <input type="number" name="commission_percent" class="form-input" required min="0" max="100" step="0.01" value="<?= h($_POST['commission_percent'] ?? '5') ?>">
                <p style="font-size:0.75rem;color:var(--secondary);margin-top:0.25rem">Suggested: 5%. Admin may accept, counter, or reject your offer before the event is published.</p>
            </div>
            <div class="form-group">
