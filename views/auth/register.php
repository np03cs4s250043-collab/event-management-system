<div class="auth-wrapper">
    <div class="auth-card" style="max-width:520px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem">
                <div class="form-group">
                    ...
                    <div class="input-icon password-field">
                        ...
                        <input type="password" id="register_password" name="password" class="form-input" placeholder="Min 8 chars, number &amp; special char" minlength="8" required>
        ...
        <div style="text-align:center;margin-top:.75rem">
            <a href="<?= APP_URL ?>/index.php" style="font-size:.7rem;color:var(--color-text-secondary);text-decoration:none">&larr; Back to Homepage</a>
        </div>
    </div>
</div>
